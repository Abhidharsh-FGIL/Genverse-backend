...
ORGS = [
    {
        "admin_email": "demo-pro-admin@genverse.dev",
        "admin_name": "Demo Pro Admin",
    ...
    {
        "admin_email": "demo-proeval-admin@genverse.dev",
        "admin_name": "Demo Pro+Eval Admin",
    ...
    async with AsyncSessionLocal() as db:
        ...
        for data in ORGS:
            ...
            for i in range(1, 3):
                ...
                print(f"  {email:<45} / {PASSWORD}  (Teacher)")
            for i in range(1, 6):
                email = f"student{i}-{slug}@genverse.dev"
                print(f"  {email:<45} / {PASSWORD}  (Student)")
